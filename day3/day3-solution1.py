...
def solution1_1():
    ...
    gamma_binary_string = str(gamma_b1) + str(gamma_b2) + str(gamma_b3) + str(gamma_b4) + str(gamma_b5) + str(gamma_b6) + str(gamma_b7) + str(gamma_b8) + str(gamma_b9) + str(gamma_b10) + str(gamma_b11) + str(gamma_b12)
    gamma_decimal = int(gamma_binary_string, 2)
    epsilon_binary_string = str(epsilon_b1) + str(epsilon_b2) + str(epsilon_b3) + str(epsilon_b4) + str(epsilon_b5) + str(epsilon_b6) + str(epsilon_b7) + str(epsilon_b8) + str(epsilon_b9) + str(epsilon_b10) + str(epsilon_b11) + str(epsilon_b12)
